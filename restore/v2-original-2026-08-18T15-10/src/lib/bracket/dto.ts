...
import { BracketCode, MatchDTO, MatchStatus, PlayerDTO, ROUND_NAMES } from "../types";

type MatchWithRelations = Match & { player1: Player | null; player2: Player | null; points: { slot: number }[] };
