...
export default function Trophy({ size = 220, animated = true }: { size?: number; animated?: boolean }) {
  const body = (
    <svg width={size} height={size} viewBox="0 0 120 120" aria-hidden="true" className="shrink-0 overflow-visible">
      <defs>
        <linearGradient id="v3-cup-gold" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#F2FF6B" />
          <stop offset="42%" stopColor="#C9D935" />
          <stop offset="100%" stopColor="#8A9A16" />
        </linearGradient>
        <linearGradient id="v3-cup-shine" x1="0" y1="0" x2="1" y2="0">
      ...
      {/* bowl */}
      <path d="M30 20 H90 V46 C90 66 78 78 60 78 C42 78 30 66 30 46 Z" fill="url(#v3-cup-gold)" />
      {/* rim */}
      <rect x="26" y="15" width="68" height="9" rx="4.5" fill="url(#v3-cup-gold)" />
      {/* stem + base */}
      <rect x="55" y="78" width="10" height="14" fill="url(#v3-cup-gold)" />
      <path d="M40 92 H80 L84 104 H36 Z" fill="url(#v3-cup-gold)" />
      <rect x="30" y="104" width="60" height="9" rx="4" fill="url(#v3-cup-gold)" />
