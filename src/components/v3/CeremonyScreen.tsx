    ...
    >
      ...
      <motion.h1
        ...
        className={`font-display font-bold uppercase mt-[1vh] max-w-[92vw] break-words ${
          isChampion ? "v3-shine text-gold text-shadow-glow" : "text-white"
        }`}
...
export default function CeremonyScreen({ ceremony }: { ceremony: CeremonyDTO }) {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden relative flex flex-col bg-court-bg v3-vignette">
