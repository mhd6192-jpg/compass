...
export interface V2Snapshot {
  tournament: { status: string; format: string; discipline: string; bestOfSets: number; tiebreakMode: string; raceTarget?: number; serveEvery?: number; raceWinBy?: number; gamesPerSet?: number };
