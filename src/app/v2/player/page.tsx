...
import { buildPlayerView, opponentOf, ordinal, teamsIn, type PlayerStatus, type PlayerView } from "@/lib/v2/player";
import { scoreLine } from "@/lib/v2/venue";
...
function PlayerScreen() {
  ...
  const teamId = usePlayerStore((s) => s.teamId);
