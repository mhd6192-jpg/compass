...
import V2Standings from "@/components/v2/V2Standings";
import ClubLogo from "@/components/shared/ClubLogo";
import PlayerQr from "@/components/v2/PlayerQr";
import { BRACKET_STYLE } from "@/lib/bracketStyle";
import { useNow } from "@/components/v2/useNow";
import { useV2Store } from "@/store/useV2Store";
import { buildVenueView, formatDuration, scoreLine, type CourtCard } from "@/lib/v2/venue";
import { serveInfo } from "@/lib/scoring/serve";
import { Ball } from "@/components/v2/ServeIndicator";
              ...
              return (
                <div key={slot} className="flex items-center gap-[0.8vw]">
                  ...
                  <motion.span
                    ...
                    className={`v2-digits font-display font-bold tabular-nums shrink-0 ${card.onAir ? "text-gold" : "text-white/60"}`}
