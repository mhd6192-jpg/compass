...
function ControlContent() {
  ...
  // Scene switching only drives the compass carousel; the group formats have a
  // fixed TV layout of their own.
  const isRoundRobin = snapshot.tournament.format !== "compass";
    ...
    <main className="min-h-screen p-4 max-w-lg mx-auto pb-16">
      ...
      {isRoundRobin && (
        <p className="text-white/40 text-xs text-center mb-6 -mt-2">
          The TV shows the live standings for group tournaments — scene switching below has no effect.
        </p>
      )}
