  ...
  return (
    <main className="min-h-screen flex flex-col items-center p-6 gap-8">
      <div className="text-center flex flex-col items-center gap-3 mt-6">
        <ClubLogo size={52} />
        <div>
          <p className="font-display uppercase tracking-[0.35em] text-gold/80 text-xs mb-1">Compass v3</p>
      ...
      <section className="w-full max-w-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Link href="/v3/control" className="rounded-2xl border border-court-line bg-court-panel p-5 flex items-center gap-4">
          ...
          <Link href="/v3/board" className="rounded-2xl border border-court-line bg-court-panel p-5 flex items-center gap-4">
          ...
          <Link href="/v3/player" className="rounded-2xl border border-court-line bg-court-panel p-5 flex items-center gap-4">
            <span className="text-3xl">🎾</span>
            <div className="flex-1 min-w-0">
