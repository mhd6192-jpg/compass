...
import Scoreboard from "@/components/v3/Scoreboard";
import WinnerScreen from "@/components/v3/WinnerScreen";
import CourtIdleScreen from "@/components/v3/CourtIdleScreen";
import WaitingScreen from "@/components/v3/WaitingScreen";
import FinalStandingsScreen from "@/components/v3/FinalStandingsScreen";
  ...
  if (!Number.isInteger(courtId)) {
    return (
      <div className="h-screen flex items-center justify-center text-white/50">
        Bad court in the URL — try <span className="text-gold ml-1">/v3/tv/2</span>
      </div>
    );
  }
